  ...
  <div class="login-clean" style="background-image:url('background.jpg');background-repeat:no-repeat;background-size:cover;">
    ...
    <div class="team-boxed" >
        <div class="container" >
            <div class="intro">
<br>
<div class="container-fluid" style="background-image:url('images/1284_logo.png');background-position:center;background-repeat:no-repeat;background-size:auto;height:160px;"></div>
<br>
            <div class="row people">
                <div class="col-md-6 col-lg-4 item">
                    <div class="box"><div class="container-fluid" style="background-image:url('images/stf.png');background-position:center;background-repeat:no-repeat;height:250px;"></div>
                        <p class="title"></p>
   
                    </div><a class="btn btn-primary active btn-block btn-lg" role="button" href="Loginstf.php" style="background-color:#8c0100;">STAFF</a></div>
                <div class="col"><img src="images/rahd.jpg" style="width:340px;height:315px;margin-left:4px;"></div>
